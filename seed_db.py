...
def seed():
    mongo = Mongo()
    db = mongo.db
    print("Seeding PostgreSQL (Neon) database")
    ...
    users = [
        {"username": "ImranSaab", "password": admin_password, "role": "Admin", "name": "Imran Khan (Admin)", "email": "admin@example.com", "created_at": datetime.now(), "is_primary_admin": True},
    ...
    patients_data = [
        {
            ...
            "laundryStatus": True, "laundryAmount": 3500, "gender": "Male", "age": "28",
        },
        {
            ...
            "laundryStatus": False, "laundryAmount": 0, "gender": "Male", "age": "24",
        },
        {
            ...
            "laundryStatus": True, "laundryAmount": 3500, "gender": "Male", "age": "35",
        },
    ]
    ...
    # 4. Seed Employees
    employees_data = [
        {"name": "Muhammad Rizwan", "designation": "Security", "pay": "25000", "advance": "0", "created_at": datetime.now()},
        {"name": "Abdul Hafeez", "designation": "Kitchen Staff", "pay": "20000", "advance": "500", "advance_month": datetime.now().month, "advance_year": datetime.now().year, "created_at": datetime.now()},
        {"name": "Sajid Mahmood", "designation": "Sweeper", "pay": "18000", "advance": "0", "created_at": datetime.now()},
    ]
    ...
    psych_sessions = [
        {"psychologist_id": "psych1", "date": datetime.now() - timedelta(days=1), "patient_ids": [str(patient_ids[0])], "note": "Patient showing progress.", "created_by": "psych1"},
        {"psychologist_id": "psych1", "date": datetime.now(), "patient_ids": [str(patient_ids[1])], "note": "Initial assessment done.", "created_by": "psych1"},
    ]
    ...
    patient_records = [
        {"patient_id": str(patient_ids[0]), "type": "session_note", "text": "Patient is responding well to therapy.", "date": datetime.now() - timedelta(days=10), "recorded_by": "psych1"},
        {"patient_id": str(patient_ids[0]), "type": "medical_record", "title": "Vitals", "details": "Blood pressure normal.", "date": datetime.now() - timedelta(days=5), "recorded_by": "doctor1"},
    ]
    ...
    utility_bills = [
        {"type": "Electricity", "amount": 15000, "due_date": now.strftime("%Y-%m-15"), "status": "Paid", "created_at": datetime.now() - timedelta(days=5)},
        {"type": "Gas", "amount": 4000, "due_date": now.strftime("%Y-%m-20"), "status": "Pending", "created_at": datetime.now() - timedelta(days=2)},
    ]
